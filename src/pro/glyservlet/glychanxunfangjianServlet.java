...
@WebServlet("/chaxunfangjian1Servlet")
public class glychanxunfangjianServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
         ...
         if(room!=null) {
  		   ...
  		   req.getRequestDispatcher("guanliyuan/xiugaifangjian.jsp").forward(req, resp);
         }
         else {
